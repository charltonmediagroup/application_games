...
// ═══ WORD DATA ═══
var WSample = { letters: ["D","E","A","L","S"], words: ["dales","deals","lades","lased","leads","slade","ales","dale","dals","deal","dels","elds","lade","lads","lase","lead","leas","sade","sale","seal","sled"] };
var WB = {
  MARKETING: { l: ["M","A","R","K","E","T","I","N","G"], w: ["marketing","emigrant","remaking","remating","retaking","garment","germain","granite","ingrate","karting","keratin","mangier","mankier","margent","marking","marting","metring","migrant","migrate","minaret","mintage","ragtime","raiment","ramekin","reaming","tangier","teaming","tearing","terming","airmen","argent","arking","arming","eating","enigma","gainer","gaiter","gamier","gamine","garnet","german","gratin","imager","inmate","intake","magnet","maigre","making","manger","margin","marine","market","marten","matier","mating","merkin","minger","minter","mirage","raking","rating","regain","regina","reknit","remain","remint","retain","retina","takier","taking","taming","tanker","tinker","triage","agent","aimer","amine","anger","anime","anker","gamer","gamin","gater","giant","grain","grant","grate","great","grime","image","inarm","inert","inker","inter","irate","kiter","maker","mange","mater","matin","meant","merit","miner","miter","mitre","namer","niter","nitre","ramen","range","reign","remit","retag","taken","taker","tamer","tiger","timer","tinge","train","trank","trike","akin","amen","ante","anti","earn","emir","emit","gain","gait","game","gate","gear","gent","germ","gnar","gnat","gram","gran","grim","grin","grit","item","kent","kern","king","kite","knit","mage","main","make","mane","mare","mark","mart","mate","mean","meat","mega","meta","mien","mike","mine","mink","mint","mire","mite","name","near","neat","rage","rain","rake","rang","rank","rant","rate","ream","rein","rent","ring","rink","rite","tain","take","tame","tang","tank","tare","tarn","teak","team","tear","term","tern","tier","time","tine","tire","tram","trek","trig","trim"] },
  ...
  PUBLISHED: { l: ["P","U","B","L","I","S","H","E","D"], w: ["published","sulphide","blueish","blushed","publish","sulphid","bields","bipeds","bluish","builds","bushed","bushel","busied","delish","dispel","lisped","lushed","pileus","pished","pulsed","pushed","shield","sliped","spiled","upheld","upside","bides","bield","biles","biped","blips","blued","blues","blush","buhls","build","bused","deils","delis","duels","dulse","dupes","duple","heils","helps","hides","hilus","idles","ileus","isled","leuds","lieus","lubed","lubes","ludes","piled","piles","pilus","plebs","plied","plies","plush","pseud","pubes","pubis","puled","pules","pulis","pulse","shied","shiel","shlep","shlub","sidhe","sidle","siped","slide","slipe","slued","speil","spied","spiel","spile","spued","beds","bels","bide","bids","bile","bise","bled","blip","blue","buds","buhl","bush","debs","deil","deli","dels","dibs","diel","dies","dips","dish","dubs","duel","dues","dupe","dups","edhs","elds","elhi","heil","held","help","hide","hied","hies","hips","hubs","hued","hues","ides","idle","isle","leis","leud","libs","lids","lied","lies","lieu","lipe","lips","lisp","lube","lude","lues","lush","peds","pehs","phis","pied","pies","pile","pish","pleb","pled","plie","plus","pubs","puds","pule","puli","puls","push","shed","ship","shul","side","sidh","sild","sipe","sled","slid","slip","slub","slue","sped","spud","spue","sued","supe","used"] },
};
//testing//
// ═══ KEEP GOING ═══
